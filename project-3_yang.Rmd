...
f = pwfe(~ jail+beertax+unemp, data = data, treat = "jail", outcome = "fatal_rate", unit.index = "state", time.index = "year",
    method = "unit", within.unit = TRUE, qoi = "ate", hetero.se=TRUE, auto.se=TRUE)
```
